        ...
        <div className="w-full h-full p-12 md:p-14">
          ...
          <div className="pt-5 justify-center md:justify-start">
            <span className="max-w-sm text-[1.01rem] font-normal leading-none tracking-tight text-gray-500">
              Browse our event listings to find and select the event you want to
              attend. Each listing provides detailed information to help you
              make your choice.
            </span>
          </div>
...
export default ChooseAEventSection;
