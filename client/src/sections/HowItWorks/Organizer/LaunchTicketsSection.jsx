        ...
        <div className="w-full h-full p-12 md:p-14">
          ...
          <div className="pt-5 justify-center md:justify-start">
            <span className="max-w-sm text-[1.01rem] font-normal leading-none tracking-tight text-gray-500">
              Easily launch and manage ticket sales for your events using our
              integrated platform. By leveraging Ethereum for secure
              transactions, you can ensure a seamless and efficient ticketing
              process.
            </span>
          </div>
...
export default LaunchTicketsSection;
